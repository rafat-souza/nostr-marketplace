...
export function ChatSidebar() {
  ...
  return (
    <div
      className={`absolute right-0 top-0 h-full z-40 bg-card border-l border-border shadow-xl transition-transform duration-300 ease-in-out flex flex-col
                  ...
                  .map((contact) => (
                    ...
                    >
                      {contact.profile?.image || contact.profile?.picture ? (
                        <img
                          src={contact.profile.image || contact.profile.picture}
                          alt="Avatar"
